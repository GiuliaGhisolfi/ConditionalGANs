...
class WassersteinGAN:
    ...
    def __init__(
        ...
        self.save_image_path = save_path if save_path is not None else 'wgan_train'
        self.save_path = save_path+'.h5' if save_path is not None else 'wgan.h5'
    ...
    def train(self, z_train, X_train, cX_train, z_val, X_val, cX_val, epochs, batch_size):
        ...
        for epoch in range(epochs):
            ...
            for i in range(0, len(X_val), int(len(X_val) / 4)): # Save 5 images
                ...
                path='generated_images/'+self.save_image_path+f'/generated_images_epoch_{epoch+1}_sample_{i}.png')
